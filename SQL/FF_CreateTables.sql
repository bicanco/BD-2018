-- COMANDOS PARA CRIAR TABELAS NO BANCO DE DADOS
-- RODAR O SCRIPT FF_Triggers.sql ANTES DA INSERCAO DOS DADOS
...
CREATE TABLE LOCAL (
    ...
    CONSTRAINT LOCAL_CK_POSSUIABERTURA CHECK(UPPER(POSSUIABERTURA) IN ('S', 'N')),
...
CREATE TABLE LOCACAO (
    ...
    CONSTRAINT LOCACAO_UN1 UNIQUE(FESTFOOD),
